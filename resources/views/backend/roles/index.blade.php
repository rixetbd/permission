        ...
        <div class="col-sm-12 col-md-12">
            <div class="card">
                <div class="card-header pb-0">
                    <h5>Roles List <span class="float-end"><a href="{{route('admin.roles.create')}}" class="btn btn-primary"> <i
                                    class="fa fa-plus"></i> Add Roles</a></span></h5>
                    <span>All Roles Information</span>
                </div>
                            ...
                            <tbody id="table_data">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        {{-- <a class="border-0 btn-sm btn-danger me-2" href=""><i class="fa fa-trash"></i></a> --}}
                                        <form action="{{route('admin.roles.destroy', $item->id)}}" method="post" onsubmit="return confirm('Are you sure ?')">
                                            @csrf
                                            @method('DELETE')
